...
export const Toolbar = ({ addNode, clearBoard, onSave, onLoad }) => {
  ...
  return (
    <div style={{
      width: '220px', height: '100vh', backgroundColor: '#0f0f0f', 
      borderRight: '1px solid #333', display: 'flex', flexDirection: 'column', 
      flexShrink: 0, zIndex: 10, fontFamily: 'sans-serif', userSelect: 'none'
    }}>
      ...
      <div style={{ flex: 1, overflowY: 'auto' }}>
        ...
        <div style={itemStyle} onClick={() => addNode('constant')} onMouseEnter={(e) => e.currentTarget.style.background='#222'} onMouseLeave={(e) => e.currentTarget.style.background='transparent'}>
           <div style={{ width: 28, height: 18, background: '#111', border: '1px solid #444', borderRadius: '2px', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#00ff00', fontSize: '10px', fontWeight: 'bold' }}>
             1
           </div>
           Data Bus
        </div>
      ...
      <div style={{ padding: '15px', borderTop: '1px solid #333', background: '#0a0a0a' }}>
        ...
        <button
          onClick={onSave}
          style={{ ...bottomBtnStyle, borderColor: '#00ff00', color: '#00ff00' }}
        ...
        <button
          onClick={() => document.getElementById('load-circuit-input').click()}
          style={{ ...bottomBtnStyle, borderColor: '#00aaff', color: '#00aaff' }}
        ...
        <button
          onClick={clearBoard}
          style={{ ...bottomBtnStyle, borderColor: '#ff4444', color: '#ff4444', marginBottom: 0 }}
